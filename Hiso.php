...
<head>
    ...
    <link rel="stylesheet" href="css/Hiso.css">
...
<body>
        ...
        <div class="contentWrapper">
            <div class="content">
                ...
                <ul class="ingredients-list">
                    <li><input type="checkbox" id="ingredient1"><label for="ingredient1"><span data-quantity="2">2</span> cups of milk 🥛</label></li>
                    <li><input type="checkbox" id="ingredient2"><label for="ingredient2"><span data-quantity="2">2</span> cups of water 💧</label></li>
                    <li><input type="checkbox" id="ingredient3"><label for="ingredient3"><span data-quantity="1.5">1.5</span> cup of sugar</label></li>
                    <li><input type="checkbox" id="ingredient4"><label for="ingredient4"><span data-quantity="1.5">1.5</span> cups of Hiso seeds</label></li>
                    <li><input type="checkbox" id="ingredient5"><label for="ingredient5"><span data-quantity="2">2</span> tablespoons custard powder</label></li>
                    <li><input type="checkbox" id="ingredient6"><label for="ingredient6"><span data-quantity="1">1</span> tablespoon cardamom powder</label></li>
                    <li><input type="checkbox" id="ingredient7"><label for="ingredient7"><span data-quantity="1">1</span>  pinch 🤏 of saffron</label></li>
                </ul>

                <h2>Instructions</h2>
                <ol>
                    <li>Firstly, cook the milk with water, sugar, and hiso seeds in a pot.</li>
                    <li>Secondly, in a separate bowl, dissolve the custard powder in some water, then add it to the pot with the milk mixture.</li>
                    <li>Thirdly, add cardamom and saffron to the pot and allow the drink to simmer for 10 minutes.</li>
                    <li>Your hiso drink is ready to enjoy!</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container"> <!-- Container for recipe cards -->
        ...
        <div class="card"> <!-- Another recipe card -->
            <div class="imgBx"> 
                <img src="images/redtea.JPG" alt=""> <!-- Image for the recipe -->
            </div>
            <div class="content">
                <h2>Red Tea</h2> <!-- Recipe title -->
                <p>Here we will mention the ingredients and recipes.</p> <!-- Brief description -->
                <a href="Red-tea.php" class="cardbtn">View Recipe</a>
            </div>
        </div>
