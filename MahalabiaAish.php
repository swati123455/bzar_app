...
<head>
    ...
    <title>Mahalabia Aish</title>
    <link rel="icon" type="image/x-icon" href="images/logo.png">
    <link rel="stylesheet" href="css/MahalabiaAish.css">
...
<body>
    ...
    <header class="header">
        <h1>Mahalabia Aish Recipe</h1>
    </header>

    <div class="row">
        <div class="imgWrapper">
            <img src="images/mahlbiyataish.JPG" alt="Mahalabia Aish" />
        </div>
        <div class="contentWrapper">
            <div class="content">
                ...
                <ul class="ingredients-list">
                    ...
                    <li><input type="checkbox" id="ingredient1"><label for="ingredient1"><span data-quantity="2">2</span> Cups milk 🥛</label></li>
                    <li><input type="checkbox" id="ingredient2"><label for="ingredient2"><span data-quantity="2">2</span> Tablespoons of corn 🌽 flour</label></li>
                    <li><input type="checkbox" id="ingredient3"><label for="ingredient3"><span data-quantity="1">1</span> cup of sugar</label></li>
                    <li><input type="checkbox" id="ingredient4"><label for="ingredient4"><span data-quantity="1">1</span> Tablespoon of rose 🌹 water</label></li>
                </ul>
                    <h2>Instructions</h2>
...
<!-- Footer Section -->
    <footer>
        ...
        <script src="js/MahalabiaAish.js"></script>
</body>
</html>
