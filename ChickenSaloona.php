...
<head>
    ...
    <title>Chicken Saloona</title>
    <link rel="icon" type="image/x-icon" href="images/logo.png">
    <link rel="stylesheet" href="css/ChickenSaloona.css">
        ...
        <div class="contentWrapper">
            <div class="content">
                ...
                <ul class="ingredients-list">
                    ...
                    <li><input type="checkbox" id="ingredient4"><label for="ingredient4"><span data-quantity="1">1</span> whole chicken 🐓 1000 grams</label></li>
                ...
                <ol>
                    ...
                    <li>Add chicken to the pot followed by the spice blends listed above to marinate. Blend your ingredients until the chicken is cooked.</li>
                    <li>Add and cut your carrots and potatoes to the pot along with 10 cups of water, then cover for 20 minutes on low heat.</li>
                    <li>After 20-30 minutes, your Saloona should be ready to eat with your choice of sides, rice, or bread.</li>
                    <li>Enjoy!</li>
                </ol>
            </div>
        </div>
...
<!-- Footer Section -->
    ...
    <footer>
        ...
        <script src="js/ChickenSaloona.js"></script>
</body>
</html>
