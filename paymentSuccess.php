 ...
 <!-- Payment Success Section -->
    <div class="success-container">
        ...
        <div class="success-details">
            <h2>Transaction ID: <span class="transaction-id">#TX1234567890</span></h2>
            <h3>Payment Method: <span class="payment-method">Credit Card</span></h3>
            <p>We’ve emailed you the receipt and order details. You can also view your transaction history anytime.</p>
        </div>
        <div class="cta-buttons">
            <a href="Homepage.html" class="cta-button">Return to Homepage</a>
            <a href="MyOrders.html" class="cta-button">View My Orders</a>
        </div>
    </div>
